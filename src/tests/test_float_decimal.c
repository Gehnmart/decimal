 ...
 * Edit the original source file "text_test/test_float_to_decimal.txt" instead.
 */
...
START_TEST(s21_from_float_to_decimal31) {
#line 512
  ...
  res.bits[0] = 0b00000000010100110100001001010001;
  res.bits[1] = 0b00000000000000000000000000000000;
  res.bits[2] = 0b00000000000000000000000000000000;
  res.bits[3] = 0b00000000000001110000000000000000;
  k.bits = res.bits[3];
  //   printf("res = %u\n", res.bits[0]);
  //  printf("exp = %d\n", k.bite.exp);
  s21_from_float_to_decimal(src1, &our_res);
...
Suite *s21_s21_from_float_to_decimal(void) {
  ...
  tcase_add_test(tc1_1, s21_from_float_to_decimal1);
  tcase_add_test(tc1_1, s21_from_float_to_decimal2);
  tcase_add_test(tc1_1, s21_from_float_to_decimal3);
  tcase_add_test(tc1_1, s21_from_float_to_decimal4);
  tcase_add_test(tc1_1, s21_from_float_to_decimal5);
  tcase_add_test(tc1_1, s21_from_float_to_decimal6);
  tcase_add_test(tc1_1, s21_from_float_to_decimal7);
  tcase_add_test(tc1_1, s21_from_float_to_decimal8);
  tcase_add_test(tc1_1, s21_from_float_to_decimal9);
  tcase_add_test(tc1_1, s21_from_float_to_decimal10);
  tcase_add_test(tc1_1, s21_from_float_to_decimal11);
  tcase_add_test(tc1_1, s21_from_float_to_decimal12);
  tcase_add_test(tc1_1, s21_from_float_to_decimal13);
  tcase_add_test(tc1_1, s21_from_float_to_decimal14);
  tcase_add_test(tc1_1, s21_from_float_to_decimal15);
  tcase_add_test(tc1_1, s21_from_float_to_decimal16);
  tcase_add_test(tc1_1, s21_from_float_to_decimal17);
  tcase_add_test(tc1_1, s21_from_float_to_decimal18);
  tcase_add_test(tc1_1, s21_from_float_to_decimal19);
  tcase_add_test(tc1_1, s21_from_float_to_decimal20);
  tcase_add_test(tc1_1, s21_from_float_to_decimal21);
  tcase_add_test(tc1_1, s21_from_float_to_decimal22);
  tcase_add_test(tc1_1, s21_from_float_to_decimal23);
  tcase_add_test(tc1_1, s21_from_float_to_decimal24);
  tcase_add_test(tc1_1, s21_from_float_to_decimal25);
  tcase_add_test(tc1_1, s21_from_float_to_decimal26);
  tcase_add_test(tc1_1, s21_from_float_to_decimal27);
  tcase_add_test(tc1_1, s21_from_float_to_decimal28);
  tcase_add_test(tc1_1, s21_from_float_to_decimal29);
  tcase_add_test(tc1_1, s21_from_float_to_decimal30);
  tcase_add_test(tc1_1, s21_from_float_to_decimal31);
  tcase_add_test(tc1_1, s21_from_float_to_decimal32);
  tcase_add_test(tc1_1, s21_from_float_to_decimal33);
  tcase_add_test(tc1_1, s21_from_float_to_decimal34);
  tcase_add_test(tc1_1, s21_from_float_to_decimal35);
  tcase_add_test(tc1_1, s21_from_float_to_decimal36);
  tcase_add_test(tc1_1, s21_from_float_to_decimal37);
  tcase_add_test(tc1_1, s21_from_float_to_decimal38);
  tcase_add_test(tc1_1, s21_from_float_to_decimal39);
  tcase_add_test(tc1_1, s21_from_float_to_decimal40);
  tcase_add_test(tc1_1, s21_from_float_to_decimal41);
  tcase_add_test(tc1_1, s21_from_float_to_decimal42);
  tcase_add_test(tc1_1, s21_from_float_to_decimal43);
  tcase_add_test(tc1_1, s21_from_float_to_decimal44);
  tcase_add_test(tc1_1, s21_from_float_to_decimal45);
  tcase_add_test(tc1_1, s21_from_float_to_decimal46);
  tcase_add_test(tc1_1, s21_from_float_to_decimal47);
  tcase_add_test(tc1_1, s21_from_float_to_decimal48);
